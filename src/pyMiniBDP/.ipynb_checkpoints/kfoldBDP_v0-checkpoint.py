...
class BiomarkerPipelineKFold:
    ...
    def __init__(self, adata, layer="center", y_col="Prognosis",
                 ...
                 highfreq_quantile=0.8,  
                 correlation_threshold=0.9,
                 elastic_net_l1_ratio=0.5,
                 final_elastic_net_l1_ratio=0.1,
                 use_holdout=False,  
                 holdout_size=0.2
                ):  
        ...
        self.final_elastic_net_l1_ratio = final_elastic_net_l1_ratio
    ...
    def train_final_model(self):
        ...
        self.final_model = LogisticRegressionCV(  
            penalty='elasticnet',
            solver='saga',
            l1_ratios =[self.final_elastic_net_l1_ratio],
